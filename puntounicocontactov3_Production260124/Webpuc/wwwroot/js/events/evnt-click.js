...
export function submit_eventos(ev) {
    ...
    //Campo para reseteo de password
        ...
        if (pass1.value != "" && pass2.value != "") {
            ...
            if (pass1.value === pass2.value) {
                ...
                ajax({
                    ...
                    cbSucced(respuesta) {
                        if (respuesta == "1") {//Redireccionar a login principal
                            ...
                            pass1.value = ""
                            pass2.value = ""
                            swal("¡Atención!", "No se permite ingresar la misma contraseña.", "warning"); 
                            //alertaMsn.innerHTML = "¡Atención! USTED ESTA INGRESANDO LA MISMA CONTRASEÑA. ELIJA OTRA."
                            //$("#modalId-resetPwd").modal("show")
                        }
                        else {
                            swal("¡Atención!", "Ocurrio un error inesperado", "Error");                         
                        }
                ...
                pass2.value = ""
                swal("¡Atención!", "Las contraseñas ingresadas no coinciden", "warning"); 
    ...
    //Para el proceso del directorio
        ...
        if (regx.length < 2) {
            swal("¡Atención!", "solo se acepta un mínimo de 2 caracteres", "warning");
            return false
        }
        ...
        if (re.test(input_extension)) {
            ...
            if (selected_ubicacion != 0) {// Se esta modificando la ubicacion
                ...
                if (selected_area == 0 && selected_puesto == 0) {
                    ...
                    swal("¡Atención! Se esta modificando la ubicacion", "Hay que reasignar el area y el pueto", "warning");
                    ...
                    ajax({
                        ...
                        cbSucced: function (respuesta) {
                            ...
                            swal("¡EXITO!", "Se actualizaro los datos del empleado", "success")
                ...
                if (selected_puesto == 0) {//Validar que se esta reasignando el puesto
                    //Enviar alerta para que ingresen los datos
                    swal("¡ATENCIÓN!", "Solo se esta modificando el área, hay que reasignar el PUESTO", "warning")
                    //document.getElementById('msn-alert-adminEmp').innerHTML = `<div class="alert alert-warning">
                    ...
                    ajax({
                        ...
                        cbSucced: function (respuesta) {
                            //var json = JSON.parse(respuesta)
                            swal("¡EXITO!", "Se actualizo el Área y PUESTO del empleado", "success")
                ...
                ajax({
                    ...
                    cbSucced: function (respuesta) {
                        //var json = JSON.parse(respuesta)
                        swal("¡EXITO!", "Se ha actualizado el puesto", "success")
                ...
                ajax({
                    ...
                    cbSucced: function (respuesta) {
                        //var json = JSON.parse(respuesta)
                        swal("¡EXITO!", "usted DESHABILITO AL EMPLEADO", "success")
                ...
                ajax({
                    ...
                    cbSucced: function (respuesta) {
                        //var json = JSON.parse(respuesta)
                        swal("¡EXITO!", "Se actualizo la extensión ", "success")
                ...
                swal("¡Atención!", "No se estan enviando datos cancele la operacion", "warning")
                //document.getElementById('msn-alert-adminEmp').innerHTML = `<div class="alert alert-warning">
                //                        <strong>¡Atencion!</strong> No esta enviando datos, CANCELE la operación</strong>
                //                        </div>`
            }
        } else {
            swal("¡Atención!", "No coincide el formato de la extención", "warning")
        ...
        if (select_ef === '0' || select_dep === '0' || select_puesto === '0') {
            swal("¡Atención!", "Elija la ubicacion y puesto del usuario", "warning")
            ...
            swal("¡Atención!", "ningun campo debe de estar vacio", "warning")
            ...
            ajax({
                ...
                cbSucced: function (respuesta) {
                    if (respuesta === "true") {
                        ...
                        swal("¡Exito!", "Se ha notificado del ingreso de un nuevo usuario", "success")
