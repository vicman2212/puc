...
<html lang='en'>
    ...
    <body>
        ...
        public string MsnInsertEmpleado(Empleado insertEmpModel)
        {
                        ...
                        <body>
                            <div style='font-family: ""Montserrat"";margin: auto; width: 70%'>
                                ...
                                <div style='background-color: #F6F6F6;font-family: ""Montserrat"";text-align: justify; padding: 1rem;'>
                                    ...
                                    <h4 style='border-bottom: #b38e5d solid;margin-top: .5rem;margin-bottom: 1rem;'>ELEMENTOS ACTUALIZADOS:</h4>
                                    <div style='margin-bottom: .6rem;'><strong>Número de empleado: </strong><span style='background-color: white; padding: .3rem;'>{insertEmpModel.NoEmpleado}</span></div>
                                    <div style='margin-bottom: .6rem;'><strong>Nombre Completo: </strong><span style='background-color: white; padding: .3rem;'>{insertEmpModel.Nombres}</span></div>                       
                                        <div style='width: 50%;border-top: green solid;'>
                                            <h5>Datos actualizados</h5>
                                            <div style='margin-bottom: .6rem;'><strong>Extensión </strong><span style='background-color: white; padding: .3rem;'>{insertEmpModel.Extension}</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div style='background: white;width: 100%;height: 0.5rem;'></div>
